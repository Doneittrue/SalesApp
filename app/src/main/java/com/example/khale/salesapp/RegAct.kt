...
class RegAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        req_signup.setOnClickListener {
            if (reg_password.text.toString().equals(reg_confirm.text.toString())) {
                var url = "https://30ffdb19.ngrok.io/SalesWeb/add_user.php?mobile=" +
                        reg_mobile.text.toString() + "&password=" + reg_password.text.toString() +
                ...
                rq.add(sr)
            } else Toast.makeText(this, "Password not match", Toast.LENGTH_LONG).show()
        }

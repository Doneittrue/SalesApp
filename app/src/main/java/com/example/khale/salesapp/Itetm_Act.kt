...
import kotlinx.android.synthetic.main.activity_itetm_.*

class Itetm_Act : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_itetm_)
        var cat:String=intent.getStringExtra("cat")
        var url="https://30ffdb19.ngrok.io/SalesWeb/get_items.php?category="+cat
